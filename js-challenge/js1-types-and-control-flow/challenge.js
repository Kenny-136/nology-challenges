...
export const getIsValidOnNameTag = () => (/[A-Z]/.test(nameTagOption[0]) && nameTagOption.length <= 8)
...
export const convertStringToNumber = () => Number(stringToConvert);
...
export const getHasUppercaseLetters = () => /[A-Z]/.test(stringWithUppercaseLetters)
